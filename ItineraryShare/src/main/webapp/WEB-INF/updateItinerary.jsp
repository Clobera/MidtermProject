					...
					<form action="goUpdateItinerary.do?updateId=${itinerary.id }" method="POST">
						...
						<div class="input-group mb-3">
							<span class="input-group-text" id="basic-addon1">Name</span> <input
								type="text" value="${itinerary.name }" class="form-control"
						...
						<div class="input-group mb-3">
							<span class="input-group-text" id="basic-addon1">Budget</span> <input
								type="number" class="form-control" value="${itinerary.budget }"
								placeholder="Budget" aria-label="Budget"
								aria-describedby="basic-addon1" name="budget">
						</div>

						<div class="input-group mb-3">
							<span class="input-group-text" id="basic-addon1">Start
								Date</span> <input type="date" class="form-control" aria-label="Start"
								aria-describedby="basic-addon1" value="${itinerary.startDate }"
								name="startDate" REQUIRED>
						</div>

						<div class="input-group mb-3">
							<span class="input-group-text" id="basic-addon1">End Date</span>
							<input type="date" class="form-control" aria-label="End"
								aria-describedby="basic-addon1" value="${itinerary.endDate }"
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control"
								value="${itinerary.image }" placeholder="ENTER URL"
